...
const {create}=await import(pathToFileURL(require.resolve('@bufbuild/protobuf')).href);
const {serializeSCIP,IndexSchema,MetadataSchema,ToolInfoSchema,DocumentSchema,OccurrenceSchema,SymbolRole}=await import(pathToFileURL(require.resolve('@c4312/scip')).href);
