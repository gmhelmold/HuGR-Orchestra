export const dict = {
  ...
  "dialog.subagentModels.hint": "Unchecked models are denied for subagents in this session.",
  "session.tab.tasks": "Tasks",
  "session.tasks.subagent": "Subagent",
  ...
  "session.tasks.stats.model": "Model",
  "session.tasks.stats.agent": "Agent",
  "session.tasks.stats.tools": "Tools",
  "session.tasks.stats.fails": "Fails",
  "session.tasks.stats.tokens": "Tokens",
  "session.tasks.stats.cost": "Cost",
  ...
  "janitor.notify.title.zero": "Janitor found {{count}} issues",
  "janitor.notify.title.two": "Janitor found {{count}} issues",
  "janitor.notify.title.few": "Janitor found {{count}} issues",
