...
**Invariant**: `zoom-clamping`
**Unwanted**: appDockZoom returns values below 0.5
**Witness**: app-dock-utils.test.ts:24-29
**Status**: ready (test exists on main)

### WP-023 (covers REQ-023 + GOLDEN-023)
**Invariant**: `zoom-clamping`
**Unwanted**: appDockZoom returns values above 3
**Witness**: app-dock-utils.test.ts:24-29
**Status**: ready (test exists on main)
...
**Clause**: Registry enforces max 32 profiles, 50 tabs/profile, 200 bookmarks, 1000 history, 2048 URL length
...
**Invariant**: `profile-registry`
**Clause**: ensureActive creates new profile with UUID storageKey within limits
**Witness**: app-dock-profile-registry.ts; app-dock-security.test.ts:973-980
**Status**: ready (test exists on main)
...
**Invariant**: `profile-registry`
**Unwanted**: Registry accepts manifest exceeding limits
**Witness**: app-dock-profile-registry.ts; app-dock-security.test.ts:973-980
**Status**: ready (test exists on main)
...
**Invariant**: `profile-registry`
**Unwanted**: ensureActive exceeds profile limit
**Witness**: app-dock-profile-registry.ts; app-dock-security.test.ts:973-980
**Status**: ready (test exists on main)
